...
// 获取企业列表
export async function getCommonEnterprises(params) {
  return get(`${admin}/common/enterprises`, params);
}

// 获取产品线
export async function getCommonProducts(params) {
  return get(`${admin}/common/products`, params);
}

// 表单定义分页查询
export async function postFormPage(params) {
  return post(`${admin}${GATEWAY}/form/page/domain-entity`, params);
}

// 表单详情-查询同名
export async function getSameName(params) {
...
// 从平台新增对象表单
export async function postPlatfromEntity(params) {
  return post(`${admin}${GATEWAY}/form/refer/platform/domain-entity`, params);
}

// 实例数据树形结构
export async function getFormTreePage(params) {
  return get(`${admin}${GATEWAY}/form/tree/entity/instance`, params);
}

// 实例数据-分页查询
export async function postFormInstance(params) {
...
// 实例数据保存
export async function saveFormInstance(params) {
  return post(`${admin}${GATEWAY}/form-service/bg/form/save/entity/instance`, params);
}

// 实例数据查询(当前)
export async function getCurFormInstance(params) {
...
// 实例数据批量删除
export async function deleteFormInstance(params) {
  return post(`${admin}${GATEWAY}/form/delete/entity/instance`, params);
}

// 添加平台实例数据
export async function addPlatformInstance(params) {
